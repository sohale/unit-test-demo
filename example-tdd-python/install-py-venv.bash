...
# forked from https://github.com/sohale/fullstakk/blob/main/symcir/install-py-venv.bash

# forked from https://github.com/sosi-org/grpc-arch-practice/blob/master/backend/ml/pytorch/pyinstall.bash
